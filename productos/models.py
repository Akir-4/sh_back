...
class Producto(models.Model):
    ...
    imagen_1 = models.ImageField(upload_to='https://shubikimagenes.blob.core.windows.net/fotos/', null=True, blank=True)
    imagen_2 = models.ImageField(upload_to='https://shubikimagenes.blob.core.windows.net/fotos/', null=True, blank=True, default=None)
    imagen_3 = models.ImageField(upload_to='https://shubikimagenes.blob.core.windows.net/fotos/', null=True, blank=True, default=None)
    imagen_4 = models.ImageField(upload_to='https://shubikimagenes.blob.core.windows.net/fotos/', null=True, blank=True, default=None)
